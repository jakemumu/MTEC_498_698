...
/* */
void GrainDelay::initialize(float inSampleRate, int inBlocksize)
{
...
/* */
void GrainDelay::setParameters(float inTimeSeconds, float inFeedbackAmount, float inMix, float inLPFreq, float inHPFreq)
{
...
/* */
void GrainDelay::processBlock(float* inBuffer, int inNumSamples)
{
...
/* */
void GrainDelay::processSample(float& inSample)
{
    ...
    mFeedbackSample = mRealTimeGranulator.processSample(mFeedbackSample);
